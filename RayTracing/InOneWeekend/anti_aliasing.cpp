...
void anti_aliasing_example(void)
{
    // Image
    ...
    shared_ptr<cltk::library> lib = ctx.getLibrary("anti_aliasing.cl", "", "");
    shared_ptr<cltk::function> func = lib->getFunction("anti_aliasing");
...

    {
        ...
        FILE *fptr = fopen("anti_aliasing.bmp", "wb");
