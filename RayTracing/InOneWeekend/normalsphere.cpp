...
void ray_example(void)
{
    ...
    shared_ptr<cltk::library> lib = ctx.getLibrary("normalsphere.cl", "", "");
    shared_ptr<cltk::function> func = lib->getFunction("normalsphere");
    ...
    func->NDR(2, gsize, NULL).exec(buf, origin, horizontal, vertical, lower_left_corner);
    {
        ...
        FILE *fptr = fopen("normalsphere.bmp", "wb");
