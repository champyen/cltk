...
typedef struct camera
{
    camera(
        ...
        origin = lookfrom.e;
        vec3 hori = (viewport_width * u);
        horizontal = hori.e;
        vec3 vert = (viewport_height * v);
        vertical = vert.e;
        lower_left_corner = (lookfrom - hori/2.0f - vert/2.0f - w).e;
    }
    ~camera() {}
...
void camera_example(void)
{
    ...
    shared_ptr<cltk::library> lib = ctx.getLibrary("camera.cl", "", "");
    shared_ptr<cltk::function> func = lib->getFunction("camera_demo");
