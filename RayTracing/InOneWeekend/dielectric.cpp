...
void dielectric_example(void)
{
    ...
    shared_ptr<cltk::library> lib = ctx.getLibrary("dielectric.cl", "", "");
    shared_ptr<cltk::function> func = lib->getFunction("dielectric");
...

    {
        ...
        FILE *fptr = fopen("dielectric.bmp", "wb");
